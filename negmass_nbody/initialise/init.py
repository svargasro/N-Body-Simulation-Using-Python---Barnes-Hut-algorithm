...
def initialise_halo_params():
    ...
    limit = 80000
    radius = 4
    num_pos_particles = 50
    num_neg_particles = 450
...
def particle_halo_init(G, num_pos_particles, num_neg_particles, num_tot_particles, limit, m_pos, m_neg, a_scale, gauss_vel_comp, cube_neg_width):
    ...
    # Set all the masses:
    if num_pos_particles > 0: #Optimizar
    ...
    # Initially set all velocities to zero:#Optimización (Crea un arreglo random y luego a 0.) 
